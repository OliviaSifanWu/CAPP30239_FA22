/* Bar chart for library visits for the public libraries around the University of Chicago */
...
d3.csv("library_visits_jan22.csv").then(data => {
    ...
    const height = 400,
          width = 600,
          margin = ({ top: 25, right: 30, bottom: 35, left: 50 }); // set variables for web page layout
